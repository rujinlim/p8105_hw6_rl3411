...
```
    ...
    ## Warning: There were 3417 warnings in `mutate()`.
    ...
    ## ! NaNs produced
    ## ℹ Run `dplyr::last_dplyr_warnings()` to see the 3416 remaining warnings.
...
|:----------|-----------:|----------:|
| logb1b2   | -8.9079751 | -4.625800 |
| r.squared |  0.8888106 |  0.940448 |
...
![](p8105_hw6_rl3411_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
