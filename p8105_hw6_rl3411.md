...
```
    ...
    ## Warning: There were 3308 warnings in `mutate()`.
    ...
    ## ! NaNs produced
    ## ℹ Run `dplyr::last_dplyr_warnings()` to see the 3307 remaining warnings.
...
|:----------|-----------:|-----------:|
| logb1b2   | -9.1600521 | -4.5753240 |
| r.squared |  0.8892241 |  0.9402649 |
