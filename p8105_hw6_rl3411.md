...
```
    ...
    ## Warning: There were 3403 warnings in `mutate()`.
    ...
    ## ! NaNs produced
    ## ℹ Run `dplyr::last_dplyr_warnings()` to see the 3402 remaining warnings.
...
|:----------|-----------:|-----------:|
| logb1b2   | -9.1227083 | -4.5125947 |
| r.squared |  0.8886013 |  0.9407739 |
...
[here](http://www.sthda.com/english/articles/37-model-selection-essentials-in-r/154-stepwise-regression-essentials-in-r/#).
